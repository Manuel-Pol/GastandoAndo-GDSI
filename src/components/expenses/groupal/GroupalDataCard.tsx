...
const GroupalDataCard = ({ groups, onSelect, selectedGroup, onDelete }: GroupDataCardProps) => {
    const change = () => console.log("xd")

    return (
        <div className='w-full'>
            {groups.length !== 0 ? 
                groups.map((group, idx) => 
                    <div className={ selectedGroup && selectedGroup[EntityWithIdFields.Id] === group[EntityWithIdFields.Id] ? 
