                ...
                </DialogTrigger>
                {
                    ...
                    <DialogContent className='min-w-[400px] bg-white rounded'>
                        <div className='flex flex-row justify-between items-center py-6 border-b-gray-400 border-b-[1px]'>
                            <DialogTitle className='text-black mb-2'>{movement[ExpensesInterfaceFields.Title]}</DialogTitle>
                            <div className='space-x-4'>
                                ...
                                <Badge className='bg-[#e8ebe9] px-3 text-[14px]'>{getExpenseRecurrence(movement[ExpensesInterfaceFields.Recurrence])}</Badge>
                            </div>
                        </div>
